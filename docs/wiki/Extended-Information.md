...
[field reference](Field-Reference) lists all of them with their exact names.
...
[V1/V2 compatibility](Card-Generations) for the per-field table.
...
- [Field reference](Field-Reference) for every field and Rust type
