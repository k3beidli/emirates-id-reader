...
hardware. Reader/driver validation must follow [testing and hardware validation](Testing) separately.
...
Do not edit generated Wiki pages directly. See [documentation maintenance](Wiki-Setup) for the
