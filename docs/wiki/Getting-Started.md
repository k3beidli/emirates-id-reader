...
Native transport supports Windows, Linux, and macOS. See [platform setup](Platforms)
...
Continue with [API reference](API-Reference), [application integration](Application-Integration),
