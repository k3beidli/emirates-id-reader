...
[`identity()`](Field-Reference), and are not part of any name accessor.
...
The [V1 field specification](Sources#fields-stored-in-uae-id-card-v1)
...
- [Data model and formatting](Data-Model) for the policy behind the split
- [Field reference](Field-Reference) for the underlying fields
- [V1/V2 compatibility](Card-Generations): both generations store Arabic and
  English full names
