...
| Missing PC/SC library during build | Install the platform PC/SC development files; see [installation and platforms](platforms.md) |
...
| `InvalidData` | A required value or card response failed validation; see [errors and read statuses](error-handling.md) |
...
See [errors and read statuses](error-handling.md) for what each error kind and
group status means, and [testing and hardware validation](testing.md) for a
