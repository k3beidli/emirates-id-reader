...
| `formatted_name()`, `formatted_name_in()` | [Names](names.md) |
| `formatted_id_number()` | [Codes and identifiers](codes-and-identifiers.md) |
| `photo()` | [Photos and signatures](photos-and-signatures.md) |
...
- [Data model and formatting](data-model.md): what the library decodes, and what it
  leaves to you
