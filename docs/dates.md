...
- [Data model and formatting](data-model.md) for shared value conventions
- [Field reference](field-reference.md) for the exact fields and types
- [Architecture and chip communication](architecture.md) for date decoding
